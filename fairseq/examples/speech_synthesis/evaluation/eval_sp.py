...
def eval_distortion(samples, distortion_fn, device="mps"):
    nmiss = 0
    results = []
...
def eval_mel_cepstral_distortion(samples, device="mps"):
    return eval_distortion(samples, batch_mel_cepstral_distortion, device)


def eval_mel_spectral_distortion(samples, device="mps"):
