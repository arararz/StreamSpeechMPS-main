...
#include "lightconv_mps.cuh"

std::vector<at::Tensor> lightconv_mps_forward(at::Tensor input, at::Tensor filters, int padding_l) {
...
"""
    ...
    with open("lightconv_mps_forward.cu", "w") as forward:
        forward.write(head)
        for seq in seqs:
...
"""
    ...
    with open("lightconv_mps_backward.cu", "w") as backward:
        backward.write(head)
