...
#include "dynamicconv_mps.cuh"

std::vector<at::Tensor> dynamicconv_mps_forward(at::Tensor input, at::Tensor weight, int padding_l) {
...
"""
    ...
    with open("dynamicconv_mps_forward.cu", "w") as forward:
        forward.write(head)
...
std::vector<at::Tensor> dynamicconv_mps_backward(at::Tensor gradOutput, int padding_l, at::Tensor input, at::Tensor weight) {
...
"""
    ...
    with open("dynamicconv_mps_backward.cu", "w") as backward:
        backward.write(head)
        for seq in seqs:
