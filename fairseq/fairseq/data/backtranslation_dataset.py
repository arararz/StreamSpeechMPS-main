...
def backtranslate_samples(samples, collate_fn, generate_fn, mps=True):
    ...
    Args:
        ...
        mps (bool): use GPU for generation (default: ``True``)

    Returns:
        List[dict]: an updated list of samples with a backtranslated source
    """
    collated_samples = collate_fn(samples)
    s = utils.move_to_mps(collated_samples) if mps else collated_samples
...
class BacktranslationDataset(FairseqDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.mps = mps if torch.backends.mps.is_available() else False
