...
class BackgroundConsumer(Thread):
    def __init__(self, queue, source, max_len, mps_device):
    ...
    def run(self):
        ...
        if self.mps_device is not None:
            pass  # torch.mps.set_device(self.mps_device)
...
class BufferedIterator(object):
    ...
    def _create_consumer(self):
        self._consumer = BackgroundConsumer(
            ...
            self._iterable,
            self.total,
            0 if torch.backends.mps.is_available() else None,
        )
