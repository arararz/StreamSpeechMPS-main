...
if "mps_HOME" in os.environ:
    extensions.extend(
        [
            cpp_extension.CppExtension(
                "fairseq.libnat_mps",
                sources=[
                    "fairseq/clib/libnat_mps/edit_dist.cu",
                    "fairseq/clib/libnat_mps/binding.cpp",
                ],
            ),
            cpp_extension.CppExtension(
                "fairseq.ngram_repeat_block_mps",
                sources=[
                    "fairseq/clib/mps/ngram_repeat_block_mps.cpp",
                    "fairseq/clib/mps/ngram_repeat_block_mps_kernel.cu",
                ],
            ),
            cpp_extension.CppExtension(
                "alignment_train_mps_binding",
                sources=[
                    "examples/operators/alignment_train_kernel.cu",
                    "examples/operators/alignment_train_mps.cpp",
                ],
            ),
        ]
    )
