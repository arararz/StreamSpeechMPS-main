...
class HmtTransformerDecoder(TransformerDecoderBase):
    ...
    def bulid_cands(self, tgt_len, first_read, cands_per_token):
        tmp = torch.arange(first_read, first_read + tgt_len, device="mps").unsqueeze(1)
    ...
    def bulid_transition_mask(self, first_read, cands_per_token):
        ...
        a = torch.arange(first_read, first_read + cands_per_token, device="mps")
        b = torch.arange(first_read + 1, first_read + cands_per_token + 1, device="mps")
